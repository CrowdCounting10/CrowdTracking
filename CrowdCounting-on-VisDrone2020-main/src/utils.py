...
def logger(exp_path, exp_name):
    if not os.path.exists(exp_path):
        os.mkdir(exp_path)
        print('Path exp creato: ', exp_path)
    
    print('Path salvataggio exp: ', exp_path)
    ...
    cfg_file = open('/content/drive/MyDrive/MobileCount/CrowdCounting-on-VisDrone2020-main/src/config.py', "r")
